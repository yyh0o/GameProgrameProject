...
int main() {
    ...
    frame_list.push_back(Spirit::generateFrame('a'));
    frame_list.push_back(Spirit::generateFrame('b'));
    frame_list.push_back(Spirit::generateFrame('c'));
    frame_list.push_back(Spirit::generateFrame('d'));
    frame_list.push_back(Spirit::generateFrame('e'));
    Spirit* spirit = new Spirit(2, 2, 1, 1, frame_list);
    std::vector<Frame *> frame_list_2 = std::vector<Frame* >(0);
    frame_list_2.push_back(Spirit::generateFrame('-'));
    frame_list_2.push_back(Spirit::generateFrame('\\'));
    frame_list_2.push_back(Spirit::generateFrame('|'));
    frame_list_2.push_back(Spirit::generateFrame('/'));
    ...
    frame_list_3.push_back(Spirit::generateFrame(temp_1, 3, 3));
    frame_list_3.push_back(Spirit::generateFrame(temp_2, 3, 3));
